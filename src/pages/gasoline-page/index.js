...
export default class {
  ...
  loadItems (opt, containerId) {
    const __menu = import('../../components/gasoline-list-item')
    const __target = this.__template.querySelector(`.box-container-${containerId}`)
    __menu.then(Res => {
      return new Res.default(opt).then(html => {
  ...
  async render () {
    ...
    this.__template.innerHTML = `
      ...
      <section class="col col-lg-12 col-md-12 col-xs-12 col-sm-12 top-page-header">
        <div class="col col-lg-12 col-md-12"><br/>
          <p><b>Vehicle Gasoline List</b></p>
          <small>
            <p>
              Helps you monitor your daily gasoline consumption<br/>
            </p>
          </small>
        </div>
      </section>
        ...
        <section class="car-box-container box col col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="box-header">
            <p>
              ...
              <i class="fa fa-calendar text-muted"></i> March 2019
            </p>
            <hr/>
          </div>
